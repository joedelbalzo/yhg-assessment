...
exports.customResponse = {
    ...
    NO_DATABASE_CONNECTION: {
        ...
        details: "The server has disconnected from the database. Please try again, and if you're still having an issue please email us at info@yourhiddengenius.com and we'll fix it right away! Thank you!",
        domain: "",
    },
    ...
    INVALID_INPUT_FORMAT: {
        ...
        details: "You have an invalid input. Please make sure your code is correct, your email is correct, and if you selected a state and a library that you have input no special characters. If you're having trouble, please email us at info@yourhiddengenius.com. Thank you!",
        domain: "",
    },
    INVALID_CODE_FORMAT: {
        success: false,
        ...
        details: "Your code's format is incorrect. Please double check that you are only entering numerical digits for your code and no spaces, letters, or other symbols. Thank you!",
        domain: "",
    },
    ...
    NOT_FOUND_CODE: {
        ...
        details: "That code is either invalid or does not exist in our system. Please double check that you are only entering numerical digits for your code and no spaces, letters, or other symbols. Thank you!",
        domain: "",
    },
    NOT_FOUND_EMAIL: {
        success: false,
        ...
        details: "We don't have that email in our database. Please try a different email address. If you're positive it was that one, please reach out to info@yourhiddengenius.com and include a picture or screenshot of your purchase receipt. Thank you!",
        domain: "",
    },
    MAXIMUM_DIGITAL_BOOKS: {
        ...
        details: "We have distributed more unique domains than we have sold copies. This is likely due to outdated sales information not received by our database. Please reach out to info@yourhiddengenius.com and include a picture or screenshot of your purchase receipt. Thank you!",
        domain: "",
    },
    NO_DOMAINS: {
        success: false,
        ...
        details: "Our system shows there are no available tests. That can't be right! Please try again. If you're having trouble, please email us at info@yourhiddengenius.com. Thank you!",
        domain: "",
    },
    CODE_LIMIT: {
        success: false,
        ...
        details: "We limit code usage on library books per the publisher's recommendations. It seems like this library book has been used too many times. Please try this again, but if you're still having trouble, please email us at info@yourhiddengenius.com. Thank you!",
        domain: "",
    },
    CSV_FAIL: {
        success: false,
        ...
        details: "Check the database for further error messages, but it's likely that there have just been no new emails since this report was last run. Thank you!",
        domain: "",
    },
    ...
    PURCHASED_AS_LIBRARY: {
        ...
        details: "Our records show that this book was purchased and that the owner already used this code. If you borrowed this book from your local library, please email us at info@yourhiddengenius.com with a photo or screenshot of your receipt and/or the library's stamp inside of the book so we can make sure it's corrected in our database. Thank you!",
        domain: "",
    },
    // UNKNOWN_ERROR: {
    //   success: false,
    ...
    UNKNOWN_ERROR: {
        ...
        statusCode: 404,
        message: "Unknown Error",
        details: "Unknown Error. Please try again. If you're still having issues, please reach out to info@yourhiddengenius.com, include a picture or screenshot of your purchase receipt, and we'll get back as soon as possible.",
        domain: "",
    },
};
//# sourceMappingURL=sendStatuses.js.map