...
const BookProvider = ({
  ...
  const [purchasedOrBorrowed, setPurchasedOrBorrowed] = reactExports.useState("");
  ...
  const [currentContent, setCurrentContent] = reactExports.useState("physicalOrDigital");
...
const ReCaptchaComponent = ({
  ...
  const V3_SITE_KEY = "6LclbgAqAAAAAM4_0-56A6GaYv6XM286cM48Naj3";
  const V2_SITE_KEY = "6LfcqhAqAAAAAKy8DrWDbHcs8P2Vmkyldwu8d2Tm";
  const [v3Status, setV3Status] = reactExports.useState("pending");
  const [v2Status, setV2Status] = reactExports.useState("idle");
  const [errorMessage, setErrorMessage] = reactExports.useState("");
  const v2ContainerRef = reactExports.useRef(null);
  const handleV3Verify = reactExports.useCallback((token) => {
    axios.post(`${baseURL}/recaptcha/verify-captcha`, {
      token,
      version: "v3"
    }).then(({
      data
      ...
      script.onload = () => {
        if (window.grecaptcha) {
          window.grecaptcha.ready(() => {
            window.grecaptcha.execute(V3_SITE_KEY, {
              action: "submit"
            }).then((token) => handleV3Verify(token));
          });
        }
      };
  ...
  const handleV2Verify = reactExports.useCallback((token) => {
    axios.post(`${baseURL}/recaptcha/verify-captcha`, {
      token,
      version: "v2"
    }).then(({
    ...
    window.onloadCallback = () => {
      if (window.grecaptcha && typeof window.grecaptcha.render === "function" && v2ContainerRef.current) {
        window.grecaptcha.render(v2ContainerRef.current, {
          sitekey: V2_SITE_KEY,
          callback: (token) => handleV2Verify(token)
        });
      }
    };
  ...
  const finalVerified = bookType === "digitalCopy" || bookType == "physicalCopy" && purchasedOrBorrowed == "borrowed" ? v3Status === "pass" && v2Status === "pass" : v3Status === "pass" || v2Status === "pass";
  reactExports.useEffect(() => {
    onVerify(finalVerified);
  }, [finalVerified, onVerify]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: v2ContainerRef, style: bigStyles.reCaptcha }),
...
const CodeFormComponent = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { id: "jdb-Form", style: windowWidth > 768 ? bigStyles.jdbCodeForm : smallStyles.jdbCodeForm, onSubmit: continueToEmailForm, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "jdb-Input", "aria-label": "Enter your code", style: windowWidth > 768 ? bigStyles.jdbInput : smallStyles.jdbInput, placeholder: "Enter your code.", value: code || "", onChange: (ev) => setCode(ev.target.value) }),
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "jdb-Submit-ButtonId", style: windowWidth > 768 ? bigStyles.jdbSubmitButtonId : smallStyles.jdbSubmitButtonId, "aria-label": "Loading", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingComponent, { height: "20px", width: "20px", borderWidth: "2px" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "jdb-Submit-ButtonId", disabled: !isVerified || !isCodeValid, style: windowWidth > 768 ? {
      ...
      gridRow: "5",
      color: !isVerified || !isCodeValid ? "gray" : "white"
    }, "aria-label": "Submit code", children: "Submit" })
  ] });
};
const EbookCodeFormComponent = ({
  ...
  const [codeError, setCodeError] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { id: "jdb-Form", style: windowWidth > 768 ? bigStyles.jdbCodeForm : smallStyles.jdbCodeForm, onSubmit: continueToEmailForm, children: [
    ...
    }, children: "In the next field, with lower case letters and with no punctuation, please tell us the last word of Chapter One (1)." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "jdb-Input", "aria-label": "Enter the code word", style: windowWidth > 768 ? {
      ...bigStyles.jdbInput,
      gridRow: "3",
      marginTop: "8px",
      outline: !codeError && !codePassed ? "inherit" : codeError ? "3px solid red" : "3px solid green"
    } : {
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "jdb-Submit-ButtonId", style: windowWidth > 768 ? {
      ...
      ...smallStyles.jdbSubmitButtonId,
      gridRow: "5"
    }, "aria-label": "Loading", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingComponent, { height: "20px", width: "20px", borderWidth: "2px" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "jdb-Submit-ButtonId", disabled: isSubmitDisabled, style: windowWidth > 768 ? {
      ...bigStyles.jdbSubmitButtonId,
      gridRow: "5",
...
const EmailFormComponent = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { id: "jdb-Form", style: windowWidth > 768 ? bigStyles.jdbEmailForm : smallStyles.jdbEmailForm, onSubmit: (event) => {
    event.preventDefault();
    handleCodeSubmission(buttonTrigger);
  }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "jdb-Input", "aria-label": "Enter your email address", style: {
      marginBottom: "12px",
      gridRow: "1",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "jdb-Input", "aria-label": "Confirm your email address", style: {
      ...windowWidth > 768 ? bigStyles.jdbInput : smallStyles.jdbInput,
      marginTop: "12px",
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "jdb-Submit-ButtonId", style: windowWidth > 768 ? bigStyles.jdbSubmitButtonId : smallStyles.jdbSubmitButtonId, disabled: true, "aria-label": "Loading", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingComponent, { height: "20px", width: "20px", borderWidth: "2px" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "jdb-Submit-ButtonId", disabled: !allowSubmit, style: windowWidth > 768 ? {
      ...bigStyles.jdbSubmitButtonId,
...
const loadLibrary = async (state) => {
  ...
  if (idx <= 12) {
    module = await __vitePreload(() => import("./librariesAtoH-7Y6bin4B.js"), true ? [] : void 0);
  } else if (idx <= 29) {
    module = await __vitePreload(() => import("./librariesItoM-CN634J6V.js"), true ? [] : void 0);
  } else if (idx <= 43) {
    module = await __vitePreload(() => import("./librariesNtoP-BGhLnslZ.js"), true ? [] : void 0);
  } else {
    module = await __vitePreload(() => import("./librariesQtoZ-DewhoAqf.js"), true ? [] : void 0);
  }
...
const useContentMap = () => {
  ...
  }, onClick, "aria-label": ariaLabel, type: "button", children });
  reactExports.useEffect(() => {
  ...
  const handleContinueToEmail = (event) => {
    event.preventDefault();
    setCurrentContent("enterEmail");
  };
  const contentMap = {
    physicalOrDigital: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles["questionStyle"], children: " Select your book edition:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "flex", style: styles["flexStyle"], children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(StyledButton, { onClick: () => handleBookType("digitalCopy"), ariaLabel: "Select Digital Copy", children: "eBooks or Audiobooks" })
      ] })
    ] }),
    purchasedOrBorrowed: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles["questionStyle"], children: "Did you purchase the book or borrow from a library?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "flex", style: styles["flexStyle"], children: [
    ...
    enterARCCode: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles["questionStyle"], children: " Wonderful!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
        ...styles["questionStyleSmaller"],
        fontSize: "calc(12px + 1vw)",
        ...
        textAlign: "left",
        width: "85%"
      }, children: "Please enter the code you were given! Most of these codes were either mailed with your copy or emailed to you." }),
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CodeFormComponent, { continueToEmailForm: handleContinueToEmail }) })
    ] }),
    enterPhysicalCode: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
        ...
        "Note: We understand that some codes may be printed backward. You can read them correctly by holding your sticker up to a light or using a mirror. We’re sorry for the trouble! For visual examples or more information,",
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.yourhiddengenius.com/faq#block-yui_3_17_2_1_1730734523784_58106", target: "_blank", style: {
          color: "whitesmoke"
        }, children: "please refer to our FAQ." }),
        " "
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CodeFormComponent, { continueToEmailForm: handleContinueToEmail }) })
    ] }),
    enterDigitalCode: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles["questionStyle"], children: " Nice!" }),
      purchasedOrBorrowed === "purchased" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("li", { style: {
        ...
        bookType !== "digitalCopy" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
          fontSize: "1rem"
        }, children: 'If borrowed outside of the United States, please enter "International" in both columns.' }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.jdbLibraryForm, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
            flex: 1,
            position: "relative"
            ...
            }, style: styles.jdbLibraryFormLabel, "aria-haspopup": "listbox", "aria-expanded": stateSuggestions.length > 0 }),
            stateSuggestions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { role: "listbox", style: styles.jdbLibraryFormInput, children: stateSuggestions.map((state, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { role: "option", "aria-selected": idx === highlightedIndex, onMouseDown: (e) => e.preventDefault(), onClick: () => handleStateSelect(state), style: {
              padding: "0.5rem",
              cursor: "pointer",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
            ...
            }, onKeyDown: (e) => handleKeyDown(e, filteredLibraries.length, (idx) => handleLibraryInput(filteredLibraries[idx].libraryname)), style: styles.jdbLibraryFormLabel, "aria-haspopup": "listbox", "aria-expanded": filteredLibraries.length > 0 }),
            filteredLibraries.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { role: "listbox", style: styles.jdbLibraryFormInput, children: filteredLibraries.map((lib, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { role: "option", "aria-selected": idx === highlightedIndex, onMouseDown: (e) => e.preventDefault(), onClick: () => handleLibraryInput(lib.libraryname), style: {
              padding: "0.5rem",
              cursor: "pointer",
              background: idx === highlightedIndex ? "#ccc" : "transparent",
              color: idx === highlightedIndex ? "#253551" : "#FFF",
    ...
    enterEmail: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "jdb-Questions", style: styles["questionStyle"], children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(EmailFormComponent, { buttonTrigger: "handleCode" }) })
    ] }),
    checkEmailAddress: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "jdb-Questions", style: styles["questionStyle"], children: "Please enter the email address you used to redeem your code." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(EmailFormComponent, { buttonTrigger: "checkLostEmail" }) })
    ] }),
    ...
    error: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: bigStyles.jdbErrorMessages, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      "There's a good chance your code and email actually worked, and you either hit the back button and resubmitted unintentionally or there was a communication issue between here and our database. Please go back to the beginning, click",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setCurrentContent("checkEmailAddress"), style: {
        background: "none",
        border: "none",
        color: "#f15e22",
        textDecoration: "underline",
        ...
        padding: 0,
        margin: 0
      }, "aria-label": "Signed up, but forgot your unique link? Click here.", children: '"Signed up, but forgot your unique link? Click here."' }),
      ", and try to recover your domain using your email address. ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
...
const DownButton = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { fill: "#ffffff", height: "50px", width: "50px", version: "1.1", id: "Layer_1", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 330.00 330.00", transform: "matrix(1, 0, 0, 1, 0, 0)", stroke: "#0B2027", strokeWidth: "0.0033", children: [
...
const AppJDB = () => {
  ...
  const [databaseResponse, setDatabaseResponse] = reactExports.useState(null);
  ...
  const collapsibleStyles = reactExports.useMemo(() => ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    !beginAssessment && /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: styles["h1Style"], children: "REDEEM YOUR FREE APTITUDE ASSESSMENT HERE" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: beginAssessment ? bigStyles.clicked : bigStyles.unclicked, onClick: toggleCollapsible, onKeyDown: handleKeyDown, "aria-expanded": beginAssessment, "aria-controls": "assessment-content", role: "button", tabIndex: 0, children: /* @__PURE__ */ jsxRuntimeExports.jsx(DownButton, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: beginAssessment && /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { layout: true, initial: {
    ...
    }, className: "jdb-Home-Div", style: collapsibleStyles, id: "assessment-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "jdb-animation-div", style: styles["animationDivStyle"], children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        opacity: 0.1,
        y: 10
      }, transition: {
        type: "spring",
        ...
        databaseResponse == null ? contentMap[currentContent] : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles["questionStyle"], children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: databaseResponse.message }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: bigStyles.successLink, children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: databaseResponse.domain, target: "_blank", rel: "noopener noreferrer", children: databaseResponse.domain }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
            ...styles["questionStyleSmaller"],
            textAlign: "left"
          }, children: databaseResponse.details })
        ] }) }),
        (databaseResponse == null || databaseResponse.success !== true) && currentContent !== "physicalOrDigital" && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "jdb-ResetButton", style: styles["resetButtonStyle"], onClick: handleReset, "aria-label": "Go back to the previous step", children: "← Back" }),
        databaseResponse == null && currentContent == "physicalOrDigital" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "jdb-PostSubmitButton", style: {
            ...
            marginTop: "0.1rem",
            marginBottom: "0.1rem"
          }, onClick: () => window.open("https://www.yourhiddengenius.com/order", "_blank"), "aria-label": "Purchase your copy to receive your assessment code", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "Don't have the book? Order ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
              fontStyle: "italic"
            }, children: "Your Hidden Genius" }),
            " below to receive your copy, along with information to redeem your free assessment.",
            " "
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "jdb-PostSubmitButton", style: {
            ...styles["continueButtonStyle"],
            marginTop: "0.1rem",
            marginBottom: "0.1rem"
          }, onClick: () => window.open("https://www.yourhiddengenius.com/faq#block-yui_3_17_2_1_1730734523784_58106", "_blank"), "aria-label": "Click here to open the FAQ", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Questions or issues? Click here to see answers to our Frequently Asked Questions (FAQ) " }) })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
        ...
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://policies.google.com/privacy", target: "_blank", rel: "noopener noreferrer", style: {
          color: "inherit",
        ...
        "and",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://policies.google.com/terms", target: "_blank", rel: "noopener noreferrer", style: {
          color: "inherit",
          textUnderlineOffset: "2px"
...
//# sourceMappingURL=index-8675309.js.map
